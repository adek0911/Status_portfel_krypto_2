...
right_treev_wyniki['columns']=('Cena zl','Cena $','Wartość zl','Wartość $','Zysk/Strata zl','Zysk/Strata $','Zysk/Strata %')
...
def frame_wyniki():
    ...
    wyniki_opis=ttk.Label(frame_wyniki,text='Podsumowanie portfela',style='core.TLabel',font=('Helvetica',12))
    wyniki_opis.grid(row=0,column=0,columnspan=2,pady=5,padx=5)

    wyniki_o1=ttk.Label(frame_wyniki,text='Ogólny Zysk/Strata zł wynosi: ',style='core.TLabel',font=('Helvetica',12))
    ...
    wyniki_o2=ttk.Label(frame_wyniki,text='Ogólny Zysk/Strata $ wynosi: ',style='core.TLabel',font=('Helvetica',12))
    ...
    wyniki_o3=ttk.Label(frame_wyniki,text='Ogólny Zysk/Strata % wynosi: ',style='core.TLabel',font=('Helvetica',12))
    ...
    wyniki_e5=ttk.Label(frame_wyniki,text='Wartość portfela w zł wynosi: ',style='core.TLabel',font=('Helvetica',12))
    ...
    wyniki_o5=ttk.Label(frame_wyniki,text='Wartość zaiwestowana wynosi: ',style='core.TLabel',font=('Helvetica',12))
...
def krypto_price():
    ...
    for a in lista_krypto:
        ...
        r_wyniki[j].insert(2,float(dane_portfel[j][3]*r_wyniki[j][0]).__round__(2)) #Wartość zł
...
#region wykresu
    ...
    for j in range(len(dane_portfel)):
        ...
        if len(lista_wybrana[1])!=0:
            tendencja_24=str((((lista_wybrana[1][(len(lista_wybrana[1])-1)]/lista_wybrana[1][0])-1)*100).__round__(2))
